...
interface StoreContextType {
  ...
  getStudentsByCustomerId: (customerId: string) => Student[];
    ...
    () => ({
      ...
      deleteCustomer: (id) =>
        setData((d) => ({
          ...
          students: d.students.filter((s) => s.customerId !== id),
        })),
      ...
      updateOrder: (id, patch) =>
        setData((d) => ({
          ...
          events: d.events.map((e) => {
            ...
            if (e.type === "rent" && patch.rentDate)
              return { ...e, date: patch.rentDate };
            if (e.type === "return" && patch.returnDate)
              return { ...e, date: patch.returnDate };
            return e;
          }),
        })),
      deleteOrder: (id) =>
      ...
      addStudent: (s) => {
        ...
        setData((d) => ({ ...d, students: [...d.students, item] }));
        return item;
      },
      ...
      getStudentsByCustomerId: (customerId) =>
        data.students.filter((s) => s.customerId === customerId),
